...
public class Human extends creature{
    ...
    public void equipItem(Items item, int index, Scanner input) {
        if (this.equipped[index] == null) {
            ...
            System.out.println(
                    "You currently have: " + this.equipped[index].toString() + " equipped. Would you like to un-equip this item? (N or any key to continue)");
    ...
    public Items useConsumable(Scanner input) {
    ...
    public boolean hasConsumable() {
        for (Items items : this.inventory) {
            if (items != null && items.type.equals("consumable")){
                return true;
            }
        }
        return false;
